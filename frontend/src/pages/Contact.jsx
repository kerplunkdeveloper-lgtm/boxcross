...
const InputField = ({ label, placeholder, type = "text", dark = false }) => (
  <div className="flex flex-col gap-2">
    ...
    <input
      ...
      className={`w-full ${dark ? "bg-[#0a0a0a]" : "bg-[#050505]"} border border-[#222] text-sm text-gray-300 rounded-md px-4 py-3 focus:outline-none focus:border-[d9ff00] transition-colors`}
    />
  </div>
);
...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className="border-b border-[#222]">
      ...
      >
        <span className="text-white font-bold text-lg group-hover:text-[d9ff00] transition-colors">
          {question}
        </span>
...
const Contact = () => {
  const faqs = [
    {
      q: "Why choose us for your fitness journey?",
      a: "We provide state-of-the-art equipment, certified professional trainers, and a supportive community to ensure you reach your fitness goals effectively and safely.",
    },
    {
      q: "What are your operating hours?",
      a: "We are open Monday to Saturday from 5:00 am to 11:00 pm, and on Sundays from 7:00 am to 7:00 pm.",
    },
    {
      q: "Do you offer personal training?",
      a: "Yes, we offer tailored personal training sessions with certified coaches who will design a program specifically for your needs and goals.",
    },
    {
      q: "Is there a membership contract?",
      a: "We offer both flexible month-to-month options and discounted annual plans to suit your lifestyle. You can choose what works best for you without getting locked in.",
    },
  ];
    ...
    <div className="w-full bg-[#050505] min-h-screen flex flex-col font-sans text-white">
      ...
      <section className="relative w-full h-[50vh] md:h-[60vh] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            ...
            filter:
              "grayscale(1) brightness(0.2) sepia(1) hue-rotate(50deg) saturate(3)",
          }}
        ></div>
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4 mt-16">
          ...
          <div className="flex gap-2">
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className="w-8 h-1.5 bg-[d9ff00] transform skew-x-[-30deg] shadow-[0_0_10px_rgba(163,255,0,0.5)]"
              ></div>
            ))}
          </div>
        </div>
      ...
      <section className="w-full max-w-[1400px] mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-20">
        ...
        <div className="flex flex-col gap-10">
          <div>
            ...
            <p className="text-gray-400 mt-4 text-sm leading-relaxed">
              Serious about your fitness? So are we. Visit us or get in touch
              below.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-10 gap-x-6">
            ...
            <div className="flex gap-4">
              <div className="w-12 h-12 bg-[d9ff00] rounded-sm flex items-center justify-center shrink-0">
                <LocationIcon />
              </div>
          ...
          <div className="bg-[#0a0a0a] border border-[#222] rounded-xl p-6 sm:p-8 mt-2 shadow-2xl">
            <h3
              ...
              style={{ fontFamily: '"Bebas Neue", sans-serif' }}
            >
              PLEASE CONSULT US HERE
            </h3>
            <p className="text-xs text-gray-400 mb-6">
              Need expert advice? Fill in your details for a quick consultancy
              call.
            </p>
            <div className="flex flex-col gap-4">
              <input
                type="text"
                placeholder="Name"
                className="w-full bg-[#050505] border border-[#222] text-sm text-gray-300 rounded-md px-4 py-3 focus:outline-none focus:border-[d9ff00]"
              />
              <input
                type="email"
              ...
              <input
                ...
                className="w-full bg-[#050505] border border-[#222] text-sm text-gray-300 rounded-md px-4 py-3 focus:outline-none focus:border-[d9ff00]"
              />
              <button className="w-full bg-[#111] hover:bg-[#222] border border-[#333] text-white py-3.5 mt-2 rounded-lg text-xs font-bold transition-colors tracking-widest">
        ...
        <div className="bg-[#0a0a0a] border border-[#222] rounded-xl p-6 sm:p-10 relative overflow-hidden shadow-2xl flex flex-col">
          ...
          <div className="absolute top-0 right-0 w-48 h-48 pointer-events-none">
            <div className="absolute top-0 right-0 w-16 h-16 border-t-2 border-r-2 border-[d9ff00] rounded-tr-xl opacity-60"></div>
            <div className="absolute top-[-50%] right-[-50%] w-full h-full bg-[d9ff00] blur-[100px] opacity-10"></div>
          </div>
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5 flex-grow">
            ...
            <div className="col-span-1 md:col-span-2 flex flex-col gap-2">
              ...
              <div className="relative">
                <select className="w-full bg-[#050505] border border-[#222] text-sm text-gray-300 rounded-md px-4 py-3 focus:outline-none focus:border-[d9ff00] appearance-none">
            ...
            <div className="col-span-1 md:col-span-2 flex flex-col gap-2">
              ...
              <textarea
                ...
                rows="4"
                className="w-full bg-[#050505] border border-[#222] text-sm text-gray-300 rounded-md px-4 py-3 focus:outline-none focus:border-[d9ff00] resize-none"
              ></textarea>
            </div>

            <div className="col-span-1 md:col-span-2 flex flex-col gap-6 mt-4">
              <button className="bg-[d9ff00] hover:bg-white text-black font-bold text-sm px-8 py-3.5 w-fit rounded-sm transition-colors tracking-widest uppercase shadow-[0_0_15px_rgba(163,255,0,0.2)]">
                SEND MESSAGE
              </button>
              <div className="flex items-center gap-2 text-[d9ff00] text-xs font-medium">
                <InfoIcon />
          ...
          <div className="mt-10 pt-8 border-t border-[#222] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex gap-3">
              <a
                href="#"
                className="w-10 h-10 border border-[#333] hover:border-[d9ff00] rounded-sm flex items-center justify-center text-gray-400 hover:text-[d9ff00] transition-colors bg-[#050505]"
              >
                <FbIcon />
              </a>
              <a
      ...
      <section className="w-full bg-[#0a0a0a] border-t border-[#1a1a1a] grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="p-8 sm:p-12 lg:p-24 flex flex-col justify-center">
          <h2
            className="text-5xl md:text-6xl lg:text-7xl font-black mb-12 tracking-wide leading-none"
            style={{
              fontFamily: '"Bebas Neue", "Bebas Neue Fallback", sans-serif',
            }}
          >
            <span className="text-white">FREQUENTLY ASKED </span>
            <span className="text-[d9ff00]">QUESTIONS</span>
          </h2>
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=2070&auto=format&fit=crop')", // Guy talking in gym placeholder
