...
const About = () => {
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      tl.fromTo(
        videoContentRef.current.children,
        {
          y: 50,
          opacity: 0,
        },
      ...
      if (horizontalContainerRef.current && horizontalSlidesRef.current) {
        gsap.to(horizontalSlidesRef.current, {
          x: () =>
            -(horizontalSlidesRef.current.scrollWidth - window.innerWidth),
          ease: "none",
          scrollTrigger: {
  ...
  return (
    <div className="bg-[#050505] relative w-full ">
      ...
      <div
        ref={containerRef}
        className="h-screen w-full relative overflow-hidden bg-black flex items-center justify-center"
      >
        {/* about hero section  */}
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 pointer-events-none">
          <h1
            ref={textRef}
            className="text-[d9ff00] text-[25vw] md:text-[32vw] font-black leading-none m-0 p-0 tracking-tight"
            style={{
        ...
        >
          <span className="text-gray-500 tracking-[0.4em] text-[10px] md:text-xs font-bold uppercase">
            Scroll to enter
          </span>
          <div className="w-px h-16 bg-gradient-to-b from-[d9ff00] to-transparent"></div>
        </div>

        {/* Video Banner Layer (Revealed after zooming into 'O') */}
        <div
          ref={videoSectionRef}
          className="absolute inset-0 z-30  opacity-0 w-full h-full flex flex-col items-center justify-center pointer-events-auto bg-black"
        >
          {/* Background Video */}
          <video
            autoPlay
          ...
          >
            ...
            <source
              src="https://www.pexels.com/download/video/12188774/"
              type="video/mp4"
            />
          </video>
          ...
          >
            <h4 className="text-[d9ff00] font-bold tracking-[0.3em] text-xs md:text-sm uppercase mb-4 drop-shadow-md">
            ...
            >
              A WHOLE
              <br />
              <span className="text-[d9ff00]">NEW WORLD</span>
            </h2>
          </div>
        </div>
      </div>
      ...
      <section className="relative w-full bg-black py-32 px-4 flex flex-col items-center justify-center border-t border-[#111]">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {[...Array(30)].map((_, i) => (
            <div
              key={i}
              className="absolute w-1 h-1 bg-[d9ff00] rounded-full opacity-30 animate-pulse shadow-[0_0_10px_d9ff00]"
              style={{
                top: `${Math.random() * 100}%`,
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          <h4
            className="text-[d9ff00] font-bold tracking-[0.2em] text-xs md:text-sm uppercase mb-4"
            style={{
              fontFamily: '"Bebas Neue", "Bebas Neue Fallback", sans-serif',
            }}
          >
          ...
          <h2
            className="text-5xl md:text-7xl lg:text-[90px] font-black text-white uppercase leading-none mb-10 tracking-tight"
            style={{
              fontFamily: '"Bebas Neue", "Bebas Neue Fallback", sans-serif',
            }}
          >
          ...
          <p className="text-gray-400 text-sm md:text-base lg:text-lg font-medium leading-relaxed mx-auto max-w-2xl">
            From day one, our goal was simple to create Bangalore's premier
            fitness destination. We built a space that pulses with energy where
            elite equipment, a strong community, and a drive for real results
            come together. WooHoo is the result of that vision.
          </p>
        </div>
      </section>
      ...
      <div
        ...
        className=" h-screen w-full bg-[#050505] overflow-hidden flex flex-col justify-center border-t border-[#1a1a1a]"
      >
        <div
        ...
        >
          {founders.map((founder, i) => (
            <div
              key={i}
              className="w-screen h-full flex items-end justify-center relative flex-shrink-0 overflow-hidden bg-black pb-0 md:pb-10"
            >
              ...
              <h1
                className="text-[32vw] md:text-[35vw] font-black text-[d9ff00] leading-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 whitespace-nowrap"
                style={{
                  fontFamily: '"Bebas Neue", "Bebas Neue Fallback", sans-serif',
                }}
              >
              ...
              <div className="absolute bottom-8 right-6 md:bottom-12 md:right-16 z-20 text-right">
                <h3
                  className="text-[d9ff00] text-3xl md:text-5xl font-black uppercase tracking-widest drop-shadow-lg"
                  style={{
                    fontFamily:
                ...
                <p className="text-[d9ff00] text-xs md:text-sm font-bold max-w-[200px] md:max-w-[280px] ml-auto mt-2 leading-relaxed drop-shadow-md">
                  {founder.desc}
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-32 md:gap-48 relative z-10">
          ...
          <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 md:gap-20">
            ...
            <div className="w-full md:w-1/2 flex flex-col items-start text-left mt-4 md:mt-0">
              <h4
                className="text-[d9ff00] font-black tracking-widest text-xs md:text-sm uppercase mb-3"
                style={{
                  fontFamily: '"Bebas Neue", "Bebas Neue Fallback", sans-serif',
                }}
              >
              ...
              <h2
                className="text-5xl md:text-6xl lg:text-[80px] font-black text-white leading-[0.9] tracking-tight mb-6 uppercase drop-shadow-lg"
                style={{
                  fontFamily: '"Bebas Neue", "Bebas Neue Fallback", sans-serif',
                }}
              >
              ...
              <p className="text-gray-400 text-sm md:text-base font-medium leading-relaxed mb-10 max-w-lg">
                6,000 sq ft of elite equipment from Panatta, Nautilus, Real
                Leader, Shua, Booty Builder, and Nike. We don't compromise on
                quality because you shouldn't compromise on your results.
              </p>
            ...
            <div className="w-full md:w-1/2 flex justify-center md:justify-end">
              <div className="relative group w-full max-w-[550px] mx-auto md:mx-0">
                ...
                <div className="absolute -top-4 -right-4 md:-top-6 md:-right-6 w-full h-full border border-[d9ff00] rounded-[2rem] md:rounded-[3rem] z-0 transition-all duration-500 group-hover:-top-6 group-hover:-right-6 md:group-hover:-top-8 md:group-hover:-right-8"></div>
                {/* Image itself */}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-20">
            ...
            <div className="w-full md:w-1/2 flex justify-center md:justify-start">
              <div className="relative group w-full max-w-[550px] mx-auto md:mx-0">
                ...
                <div className="absolute -top-4 -left-4 md:-top-6 md:-left-6 w-full h-full border border-[d9ff00] rounded-[2rem] md:rounded-[3rem] z-0 transition-all duration-500 group-hover:-top-6 group-hover:-left-6 md:group-hover:-top-8 md:group-hover:-left-8"></div>
                {/* Image itself */}
                <div className="relative z-10 w-full rounded-[2rem] md:rounded-[3rem] overflow-hidden aspect-square bg-gray-900 shadow-2xl">
                  <img
            ...
            <div className="w-full md:w-1/2 flex flex-col items-start text-left mt-4 md:mt-0">
              ...
              <p className="text-gray-400 text-sm md:text-base font-medium leading-relaxed mb-10 max-w-lg">
                Split into smart training zones for effortless flow. From
                Panatta's machines to dedicated recovery, and functional zones,
                every detail has been built to help you train smarter and
                stronger.
              </p>
              <button className="bg-transparent border border-[#333] text-white font-bold uppercase tracking-widest px-10 py-4 text-xs md:text-sm hover:border-white hover:bg-white hover:text-black transition-all duration-300 rounded-sm">
                VIEW ZONES
          ...
          <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 md:gap-20">
            ...
            <div className="w-full md:w-1/2 flex flex-col items-start text-left mt-4 md:mt-0">
              ...
              <p className="text-gray-400 text-sm md:text-base font-medium leading-relaxed mb-10 max-w-lg">
                At WooHoo, fitness is about more than just lifting weights. It's
                about being part of a community that actually shows up. Whether
                you're a beginner or a seasoned athlete, you'll find the support
      ...
      <section className="relative w-full h-[60vh] md:h-[80vh] flex items-center justify-center overflow-hidden border-t border-[#1a1a1a]">
        ...
        <div className="relative z-10 text-center px-4 flex flex-col items-center w-full max-w-5xl">
          <h2
            className="text-6xl sm:text-7xl md:text-[90px] lg:text-[130px] font-black text-white leading-[0.9] tracking-tight mb-8 drop-shadow-2xl uppercase"
            style={{
              fontFamily: '"Bebas Neue", "Bebas Neue Fallback", sans-serif',
            }}
          >
            PUSH YOUR <span className="text-[d9ff00]">LIMITS</span>
          </h2>

          <button
            className="bg-[d9ff00] text-black font-black uppercase tracking-widest px-8 md:px-12 py-4 rounded-sm hover:bg-[#8ee000] transition-all duration-300 hover:scale-105 shadow-[0_0_20px_rgba(163,255,0,0.3)] text-sm md:text-lg"
            style={{
              fontFamily: '"Bebas Neue", "Bebas Neue Fallback", sans-serif',
            }}
          >
