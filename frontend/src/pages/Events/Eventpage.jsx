  ...
  return (
    <div className='w-full'>
      <Helmet>
        ...
        <meta property="og:image" content={`https://membership.boxandcross.com/events${coverImg}`} />
        ...
        <meta property="twitter:image" content={`https://membership.boxandcross.com/events${coverImg}`} />
      </Helmet>
