      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 py-20 flex flex-col justify-center">
        <div className="max-w-2xl flex flex-col items-start">
          ...
          >
            ...
            <span className="text-[d9ff00] drop-shadow-lg">PILATES</span>
          </h2>

          {/* Description Text */}
          <p className="text-gray-200 text-lg md:text-xl lg:text-2xl font-sans mb-10 leading-relaxed max-w-xl drop-shadow-md">
            Transform your core, flexibility, and strength with our
            state-of-the-art reformer sessions. Now open for members and
            non-members.
          </p>

          {/* Call to Action Button */}
          <button className="bg-[d9ff00] hover:bg-white  text-black font-bold text-md md:text-xl px-8 py-4 rounded-xl transition-transform duration-300 hover:scale-105 tracking-widest uppercase  shadow-[0_0_20px_rgba(163,255,0,0.3)]">
