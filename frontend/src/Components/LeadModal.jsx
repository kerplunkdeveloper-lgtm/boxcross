...
const LeadModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4 sm:p-0" style={{ zIndex: 999999 }}>
      {/* Backdrop */}
      <div
        ...
        <div className="p-6 sm:p-8">
          {step === 1 && (
            <div className="animate-fade-in text-center">
              ...
              <p className="text-gray-400 text-sm mb-6">
                Get a 3-Day Free Gym Pass. Limited time offer.
              </p>
          ...
          {step === 2 && (
            <div className="animate-fade-in text-center">
              ...
              <p className="text-gray-400 text-sm mb-6">
                Enter the demo OTP <strong className="text-white">1234</strong>{" "}
                sent to <br />
                {formData.phone}
              </p>
              ...
              <form onSubmit={handleVerifyOTP} className="space-y-4 text-left">
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-wider text-gray-500 mb-1 text-center">
                    Enter OTP
                  </label>
                  <input
                    type="text"
          ...
          {step === 3 && (
            <div className="animate-fade-in text-center py-6">
              ...
              <p className="text-gray-400 text-sm mb-6">
                Your pass has been securely claimed. Our team will contact you
                shortly.
              </p>
